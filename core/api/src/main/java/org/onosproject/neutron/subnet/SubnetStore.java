...
public interface SubnetStore extends Store<SubnetEvent, SubnetStoreDelegate> {
    ...
    /**
     * Returns an iterable collection of all subnets currently available to the
     * system.
     *
     * @return subnet collection
     */
    ...
    /**
     * Creates a new infrastructure subnet, or updates an existing one using the
     * supplied subnet description.
     *
