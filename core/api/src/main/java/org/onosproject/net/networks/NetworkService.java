...
/**
 * Service for interacting with the inventory of infrastructure network.
 */
public interface NetworkService {
    ...
    /**
     * Returns a collection of the currently known infrastructure network.
     ...
     */
    boolean networkcreate(JsonNode cfg);
     ...
     */
    boolean networkupdate(NetworkId networkId, JsonNode cfg);
}
